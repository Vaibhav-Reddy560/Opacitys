...
// POST /api/upload?projectId=...&width=...&height=...&filename=...  (body:
// raw file bytes, Content-Type set to the image mime type). The uploader is
// always the signed-in session, never a client-supplied id — the old
// version took userId as a query param, which meant anyone could upload and
// attribute an asset to any account by just changing the value in the URL.
