...
/**
 * Every stage of upload -> measure -> interpret is held on THIS page rather
 * than navigating to a separate loading screen. `AnalysisResult`'s
 ...
 * from here never sees it: this page waits out the whole pipeline itself
 * and only navigates once the real result is ready to render.
 */
