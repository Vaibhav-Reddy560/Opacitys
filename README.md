<div align="center">
  <img src=".github/readme-assets/banner.webp" alt="Opacitys" width="100%" />
  ...
  <p>
    <img src="https://img.shields.io/badge/Next.js-16-000000?style=flat-square&logo=nextdotjs&logoColor=white&labelColor=0a0a0e" alt="Next.js 16" />
    <img src="https://img.shields.io/badge/React-19-149eca?style=flat-square&logo=react&logoColor=white&labelColor=0a0a0e" alt="React 19" />
    <img src="https://img.shields.io/badge/TypeScript-5-3178c6?style=flat-square&logo=typescript&logoColor=white&labelColor=0a0a0e" alt="TypeScript" />
    <img src="https://img.shields.io/badge/Tailwind_CSS-v4-38bdf8?style=flat-square&logo=tailwindcss&logoColor=white&labelColor=0a0a0e" alt="Tailwind CSS v4" />
    <img src="https://img.shields.io/badge/Postgres-Neon-00e599?style=flat-square&logo=postgresql&logoColor=white&labelColor=0a0a0e" alt="PostgreSQL / Neon" />
    <img src="https://img.shields.io/badge/Auth-Firebase-ffca28?style=flat-square&logo=firebase&logoColor=white&labelColor=0a0a0e" alt="Firebase Auth" />
    <img src="https://img.shields.io/badge/Deployed_on-Vercel-000000?style=flat-square&logo=vercel&logoColor=white&labelColor=0a0a0e" alt="Vercel" />
  </p>
...
| [**Route**](#route) | From brief to build, with what you actually have |
| [**Instruments**](#instruments) | Know where everything is |
...
| [**Clearance**](#clearance) | Know what's actually yours to use |
...
<a id="route"></a>
<details>
<summary><strong>Route</strong> — From brief to build, with what you actually have</summary>
...
<a id="instruments"></a>
<details>
<summary><strong>Instruments</strong> — Know where everything is</summary>
...
<a id="clearance"></a>
<details>
<summary><strong>Clearance</strong> — Know what's actually yours to use</summary>
...
```mermaid
flowchart TD
    UI["Studio UI — Next.js App Router, React 19"]

    UI --> Auth["Session / Auth"]
    Auth --> Firebase[("Firebase Auth — Google sign-in")]

    UI --> Modules["Server Actions & Route Handlers"]

    Modules --> Groq[["Groq — Llama / Qwen / GPT-OSS, Whisper"]]
    Modules --> Gemini[["Gemini 2.5 Flash — vision, layer detection"]]
    Modules --> Tavily[["Tavily — live web search"]]
    Modules --> Pollinations[["Pollinations.ai — image generation"]]
    Modules --> Cloudflare[["Cloudflare Workers AI — inpainting"]]

    Modules --> DB[("Neon Postgres — via Drizzle ORM")]
    Modules --> Blob[("Vercel Blob — uploads & renders")]
